...
# Start FastAPI server in background (HTTP only)
...
# Start Streamlit app in background (HTTP only)
...
echo "✅ Both FastAPI and Streamlit started (HTTP, SSL via Cloudflare)."
